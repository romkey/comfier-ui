...
- Attachments larger than `NOTIFICATION_ATTACHMENT_MAX_MB` (default `20`, total per message) are replaced by a link.
...
| `NOTIFICATION_ATTACHMENT_MAX_MB` | Largest total attachment size per notification (default `20`) |
