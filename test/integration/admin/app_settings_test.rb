...
module Admin
  class AppSettingsTest < ActionDispatch::IntegrationTest
    ...
    test 'admins can update the attachment size limit' do
      ...
      assert_select 'input[name="app_setting[notification_attachment_max_mb]"][value="20"]'

      patch admin_app_setting_path, params: { app_setting: { notification_attachment_max_mb: 8 } }

      assert_redirected_to edit_admin_app_setting_path
      assert_equal 8, app_settings(:default).reload.notification_attachment_max_mb
    end
